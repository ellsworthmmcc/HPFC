...
If this project has already been downloaded through other means, skip to Step 2.
If there was an error that prevented this project from being usable, please re-download the project from the GitHub repository.
